...
import { putUsuarioById } from "../../../services/authService";
...
const AdminModalEditUsuario = ({
  ...
  useEffect(() => {
    setFormulario({ ...objUsuarioEditar });
  }, [objUsuarioEditar]);
  ...
  return (
    <MDBContainer>
      <MDBModal
        ...
        toggle={() => setMostrarModalEditarUsuario(false)}
        size="lg"
      >
        <MDBModalHeader toggle={() => setMostrarModalEditarUsuario(false)}>
          Editar Usuario
        </MDBModalHeader>
        <MDBModalBody>
...
export default AdminModalEditUsuario;
